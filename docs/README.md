...
- 結果：［要確認：テストが書かれるようになった範囲、カバレッジなど］
...
- 契約形態：業務委託
- 稼働：週 2.5〜3 から開始。相互に問題なければ稼働増も可
- 勤務形態：フルリモート希望。出社も相談可
- 稼働時間：平日日中の MTG は調整可能。土日・平日夜間の稼働が可能な案件を歓迎
- 希望領域：決済・認証・フィンテック領域のバックエンド、生成 AI / LLM を業務システムに組み込む案件、AI 活用の運用ルール設計
- 基本的に PC の前にいるため、レスポンスは早め

---

正社員向けの職務経歴書は[こちら](https://kojirock5260.github.io/resume/fulltime.html)を参照してください。
